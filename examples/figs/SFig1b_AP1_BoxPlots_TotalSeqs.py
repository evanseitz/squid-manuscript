...
fig_pad = 50
seq_total = 50
avgMuts = [1000,10000,20000,30000,40000,50000,60000,100000]
pos = [1,2,3,4,5,6,7,8]
#ylabels = ['1\n0.5$\%$','10\n5$\%$','20\n10$\%$','30\n15$\%$','40\n20$\%$','50\n25$\%$',
           #'60\n30$\%$','70\n35$\%$','80\n40$\%$','90\n45$\%$','100\n50$\%$']
ylabels = ['1k','10k','20k','30k','40k','50k','60k','100k']
...
fig = plt.figure(figsize=[25,7.27]) #[column width, row width]
gs1 = GridSpec(8, 3, left=0.05, right=0.27, wspace=0.1, hspace=0.2) #.37
ax1 = fig.add_subplot(gs1[:8, :3])
#ax1.axes.get_xaxis().set_ticks([])
gs0 = GridSpec(8, 3, left=0.28, right=1.34, wspace=0.1, hspace=0.2) #.38
...
plt.tight_layout()
if 1:
    plt.savefig(os.path.join(pyDir,'boxplots_totalSeqs.pdf'), facecolor='w', dpi=200)
plt.show()
