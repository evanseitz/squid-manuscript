...
# Common paths
models_dir = Path('/Volumes/EES2021/Education/5_CSHL/5_BPNet_MS/bpnet-manuscript/bpnet-manuscript-data/output/')
...
#ZULU
fasta_file = '/Volumes/EES2021/Education/5_CSHL/5_BPNet_MS/bpnet-manuscript/bpnet-manuscript-data/data/mm10_no_alt_analysis_set_ENCODE.fasta'
...
# Bam files
# ZULU
base_dir = Path('/Volumes/EES2021/Education/5_CSHL/5_BPNet_MS/bpnet-manuscript/bpnet-manuscript-data/data/')
